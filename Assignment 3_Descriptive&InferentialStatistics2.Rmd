...
# MODEL 4 - Interaction variates
L4 <- glm(DDif ~ lGDPpc + lRural + lCO2 + lHCexpend + lWater + lSanitation + lLifeExpect + lDPT + lMeasles + as.factor(QInteraction) + lFemUnempl + lFemSchool,
          data=Merged, family = 'binomial')
summary(L4)

# Regressing the model on the interaction fixing the other indendent variables at Uganda's mean
